      ...
      >
        <div className="flex items-center h-full">
          <Link to="/" className="flex items-center gap-x-1 mr-3">
            <h1
              className={` text-base md:text-2xl font-bold   hover:text-fuchsia-900 ${
          ...
          {eventData ? <div className="flex">
            <div className={`w-2 h-16 rounded-lg mx-5`} style={{backgroundColor: eventData?.color}}></div>
            <div className="flex flex-col">
              <p className="text-xl font-semibold">{eventData?.name}</p>
              <p>{eventData?.startDate?.toString().split("T")[0]} - {eventData?.endDate?.toString().split("T")[0]}</p>
            </div>
          </div> : ""}
        </div>
        <div
          ...
          {isLoggedIn ? (
            <>
              <button
                ...
                className="p-3 rounded-full border-sky-500 font-bold bg-sky-300 hover:!text-white"
              >
            ...
            <>
              <Link to="/signup" className="hover:text-sky-500  text-xl">

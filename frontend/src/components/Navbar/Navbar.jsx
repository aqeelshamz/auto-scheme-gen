        ...
        <div className=" relative bg-white text-black z-[2000] box-border ">
            ...
            <div
                className={`${position >= 150 &&
                    ...
                    } flex justify-between items-center py-4 px-3 z-[2000] border-b ${position < 150
                        ? `border-black/40`
                        : `border-white/40`
                    }`}
            >
                <Link to="/" className="flex items-center gap-x-1">
                    ...
                    <h1
                        className={` text-base md:text-2xl font-bold   hover:text-sky-500 ${position < 150 &&
                            `text-black`
                            }`}
                    >
                        <div >
                ...
                <div
                    className={`hidden md:block text-base md:text-2xl font-bold   hover:text-sky-500 ${position < 150 &&
                        `text-black`
                        }`}
                >
                    {/* <Link

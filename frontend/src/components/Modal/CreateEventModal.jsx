				...
				>
					...
					<div className="m-4">
						...
						<div className="mt-3  flex justify-between ">
							<DatePicker
								className="w-[199px] h-[35px]  px-4 py-2 bg-blue-100 border border-gray-300 text-white rounded-md  require outline-none focus:outline-none focus:ring focus:border-blue-500 text-xs"
								selected={""}
								onChange={""}
